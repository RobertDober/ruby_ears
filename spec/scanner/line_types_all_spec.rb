...
RSpec.describe RubyEars::Scanner do
  ...
  [
    ...
    #1234567890123
    [ "   a",         Scanner::Text.new({content: "a", line: "   a"}) ],
    [ "    b",        Scanner::Indent.new({level: 1, content: "b"}) ],
    [ "      c",      Scanner::Indent.new({level: 1, content: "  c"}) ],
    [ "        d",    Scanner::Indent.new({level: 2, content: "d"}) ],
    [ "          e",  Scanner::Indent.new({level: 2, content: "  e"}) ],
    [ "    - f",      Scanner::Indent.new({bullet: "-", level: 1, content: "- f"}) ],
    [ "     *  g",    Scanner::Indent.new({bullet: "*", level: 1, content: " *  g"}) ],
    [ "      012) h", Scanner::Indent.new({bullet: "012)", level: 1, content: "  012) h"}) ],
    ...
    [ id6, Scanner::IdDef.new({id: "ID6", url: "http://example.com", title: "The title"}) ],
    [ id7, Scanner::IdDef.new({id: "ID7", url: "http://example.com", title: "The title"}) ],
    [ id8, Scanner::IdDef.new({id: "ID8", url: "http://example.com", title: "The title"}) ],
  ...
  [ "[^1]: bar baz", Scanner::Text.new({content: "[^1]: bar baz",
    ...
    it "Example: #{idx.succ}, transforms #{input.inspect} into #{expected}" do
      ...
      expected.line = input
      expected.indent ||= 0
      expect(Scanner.type_of(input,lnb: lnb)).to eq(expected)
    end
  end
